...
const styles = StyleSheet.create({
  ...
  emptyDesc: { fontSize: 14, textAlign: 'center', lineHeight: 20, marginBottom: SPACING.xl },
  ...
  dialogTitle: { fontSize: 18, fontWeight: '700', marginBottom: SPACING.sm },
  dialogMessage: { fontSize: 14, lineHeight: 20, marginBottom: SPACING.xl },
